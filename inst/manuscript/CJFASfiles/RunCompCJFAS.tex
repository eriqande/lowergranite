...
\author[K. Steinhorst]{Kirk Steinhorst} %% opt. arg. ONLY if IDbox
                                      %% name is diff. from
                                      %% titleblock name 
\address{Department of Statistical Science, University of Idaho, Moscow, ID 83844-1104}     %% address of 1st author
...
\address{Fisheries Ecology Division, Southwest Fisheries Science Center, National Marine Fisheries Service, NOAA, Santa Cruz, CA, 95060}
...
\keywords{Run Composition, Salmonid Escapement, Stratified Sampling, Bootstrap Confidence Intervals}
%% \translation 
\end{abstract}
